                              ...
                              int n_pipeline )
{
  ...
  for( ; nq; nq--, pb++, ipart += 16 )
  {
    ...
    //--------------------------------------------------------------------------
    store_16x1(  dx, &pb[0].dx[0] );
    store_16x1(  dy, &pb[0].dy[0] );
    store_16x1(  dz, &pb[0].dz[0] );
                              ...
                              int n_pipeline )
{
  ...
  for( ; nq; nq--, p+=16 )
  {
    ...
    // Store particle data, final.
    //--------------------------------------------------------------------------
    store_16x8_tr_p( dx, dy, dz, ii, v06, v07, v08, q,
                              ...
                              int n_pipeline )
{
  ...
  ERROR( ( "No uncenter_p_plus_pipeline_v16 implementation." ) );
}
