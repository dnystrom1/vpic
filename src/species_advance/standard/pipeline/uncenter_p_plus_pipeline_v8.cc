                             ...
                             int n_pipeline )
{
  ...
  for( ; nq; nq--, pb++, ipart += 8 )
  {
    ...
    store_8x1( v06, &pb[0].ux[0] );
    store_8x1( v07, &pb[0].uy[0] );
    store_8x1( v08, &pb[0].uz[0] );
                             ...
                             int n_pipeline )
{
  ...
  for( ; nq; nq--, p+=8 )
  {
    ...
    // Store particle data, final.
    //--------------------------------------------------------------------------
    store_8x8_tr( dx, dy, dz, ii, v06, v07, v08, q,
                             ...
                             int n_pipeline )
{
  ...
  ERROR( ( "No uncenter_p_plus_pipeline_v8 implementation." ) );
}
