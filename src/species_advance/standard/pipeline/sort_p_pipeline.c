...
coarse_count_pipeline_scalar( sort_p_pipeline_args_t * args,
                              ...
                              int n_pipeline )
{
  const particle_block_t * RESTRICT ALIGNED(128) pb_src = args->pb;
...
{
  const particle_block_t * RESTRICT ALIGNED(128) pb_src = args->pb;
  /**/  particle_block_t * RESTRICT ALIGNED(128) pb_dst = args->aux_pb;
...
subsort_pipeline_scalar( sort_p_pipeline_args_t * args,
                         ...
                         int n_pipeline )
{
  const particle_block_t * RESTRICT ALIGNED(128) pb_src = args->aux_pb;
  /**/  particle_block_t * RESTRICT ALIGNED(128) pb_dst = args->pb;
...
sort_p_pipeline( species_t * sp )
{
  ...
  particle_block_t * RESTRICT ALIGNED(128) pb = sp->pb;
  particle_block_t * RESTRICT ALIGNED(128) aux_pb;
  ...
  aux_pb           = ALIGN_PTR( particle_block_t, scratch,            128 );
