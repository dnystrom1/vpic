                           ...
                           int n_pipeline )
{
  ...
  for( ; nq; nq--, pb++, ipart += 4 )
  {
    ...
    //--------------------------------------------------------------------------
    store_4x1( dx, &pb[0].dx[0] );
    store_4x1( dy, &pb[0].dy[0] );
    store_4x1( dz, &pb[0].dz[0] );

    // store_4x1( v03, &pb[0].dx[0] );
    // store_4x1( v04, &pb[0].dy[0] );
    // store_4x1( v05, &pb[0].dz[0] );
                           ...
                           int n_pipeline )
{
  ...
  ERROR( ( "No center_p_plus_pipeline_v4 implementation." ) );
}
