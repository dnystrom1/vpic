                            ...
                            int n_pipeline )
{
  ...
  for( ; nq; nq--, pb++, ipart += 8 )
  {
    ...
    //--------------------------------------------------------------------------
    store_8x1( dx, &pb[0].dx[0] );
    store_8x1( dy, &pb[0].dy[0] );
    store_8x1( dz, &pb[0].dz[0] );

    store_8x1( ux_old, &pb[0].ux[0] );
    store_8x1( uy_old, &pb[0].uy[0] );
    store_8x1( uz_old, &pb[0].uz[0] );
