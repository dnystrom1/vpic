                  ...
                  const species_t * RESTRICT sp )
{
  ...
  const particle_block_t * RESTRICT ALIGNED(128) pb = sp->pb;
  ...
  for( n = 0; n < np; n++ )
  {
    ...
    ib = n / PARTICLE_BLOCK_SIZE;
    ip = n - PARTICLE_BLOCK_SIZE * ib;
    ...
    ERROR( ( "Need AoSoA implementation for v4 version of accumulate_rho_p." ) );
